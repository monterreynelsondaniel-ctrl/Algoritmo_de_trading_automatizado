...
2. Revisar y congelar la auditoría comparativa V1/V2: 8 approvals retenidos, 25
   nuevos y reason codes controlados, sin abrir outcomes.
3. Diseñar después un análisis de outcomes pre-registrado que compare la selección
